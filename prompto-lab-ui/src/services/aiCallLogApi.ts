...
export const aiCallLogApi = {
  ...
  async getAllLogSummaries(): Promise<AICallLogSummary[]> {
    return apiJsonRequest(`${API_CONFIG.BASE_URL}/sf/api/ai-logs`, {
      method: 'GET',
      requireAuth: true
    })
  },
  ...
  async getFullLog(callId: string): Promise<AICallLog> {
    return apiJsonRequest(`${API_CONFIG.BASE_URL}/sf/api/ai-logs/${encodeURIComponent(callId)}`, {
      method: 'GET',
      requireAuth: true
    })
  },
  ...
  async getLogSummariesByOperation(operationType: string): Promise<AICallLogSummary[]> {
    return apiJsonRequest(`${API_CONFIG.BASE_URL}/sf/api/ai-logs/operation/${encodeURIComponent(operationType)}`, {
      method: 'GET',
      requireAuth: true
    })
  },
  ...
  async getLogSummariesByModel(modelName: string): Promise<AICallLogSummary[]> {
    return apiJsonRequest(`${API_CONFIG.BASE_URL}/sf/api/ai-logs/model/${encodeURIComponent(modelName)}`, {
      method: 'GET',
      requireAuth: true
    })
  },
  ...
  async getStatistics(): Promise<LogStatistics> {
    return apiJsonRequest(`${API_CONFIG.BASE_URL}/sf/api/ai-logs/statistics`, {
      method: 'GET',
      requireAuth: true
    })
  },
